...
public class PerformanceMonitoringFragment extends Fragment {
    ...
    private PieChart mBarChart_intimations_processed_district_faisalabad;
    private PieChart mBarChart_intimations_processed;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        showDivisionWiseDiseaseInitimationProcessed(frg);
        showpieDistrictFaisalabadIntimationsProcessed();
        showTehsilFaisalabadMuzzaWiseIntimationProcessed(frg);
    ...
    private void bindViews(View frg) {
        mBarChart_intimations_processed = frg.findViewById(R.id.frg_home_mpchart_intimations_processed);
        mBarChart_intimations_processed_district_faisalabad = frg.findViewById(R.id.frg_home_mpchart_intimations_processed_district_faisalabad);
    ...
    private void showPieIntimationsProcessed() {
        ...
        PieChartManagger pieChartManagger = new PieChartManagger(mBarChart_intimations_processed, getContext());
    ...
    private void  showpieDistrictFaisalabadIntimationsProcessed() {
        ...
        PieChartManagger pieChartManagger = new PieChartManagger(mBarChart_intimations_processed_district_faisalabad, getContext());
        pieChartManagger.showSolidPieChartNew(yvals, colors);
    }


    private void  showDivisionWiseDiseaseInitimationProcessed(View frg){



        BarChart barChartView = frg.findViewById(R.id.DivisionWiseDiseaseInitimationProcessed_barchart);
...
//        barDataSet1.label = "2016";
    ...
    private void   showTehsilFaisalabadMuzzaWiseIntimationProcessed(View frg){



        BarChart barChartView = frg.findViewById(R.id.TehsilFaisalabadMuzzaWiseIntimationProcessed_barchart);
